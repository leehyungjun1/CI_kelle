...
class JyAdmin extends Model
{
    ...
    protected $allowedFields    = ['admin_id','password','email','name','regist_YN', 'department_code','position_code','title','relations','profile_path', 'duty_code','is_best','phone','employee_kind','created_at','updated_at','deleted_at'];
