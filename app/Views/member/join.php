<div class="member_cont">
    <form id="frm" name="formJoin" action="<?= site_url('member/join_submit') ?>" method="post" novalidate="novalidate">
        <?=csrf_field() ?>
            ...
            <div class="base_info_sec">
                <table>
                    ...
                    <tr class="">
                        ...
                        <td>
                            <div class="member_warning">
                                <input type="password" class="check-id" name="password_confirm" autocomplete="off">
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="member_email">
                            <div class="member_warning">
                                ...
                                <select id="emailDomain" name="emailDomain" class="chosen-select" style="display: none;">
                                ...
                                </select><div class="chosen-container chosen-container-single chosen-container-single-nosearch" title="" id="emailDomain_chosen" style="width: 120px;"><a class="chosen-single">
                                        <span>직접입력</span>
                                        <div><b></b></div>
                                    </a>
                                    <div class="chosen-drop">
                                        ...
                                        <ul class="chosen-results"><li class="active-result result-selected" data-option-array-index="0">직접입력</li><li class="active-result" data-option-array-index="1">hanmail.net</li><li class="active-result" data-option-array-index="2">daum.net</li><li class="active-result" data-option-array-index="3">nate.com</li><li class="active-result" data-option-array-index="4">hotmail.com</li><li class="active-result" data-option-array-index="5">gmail.com</li><li class="active-result" data-option-array-index="6">icloud.com</li></ul>
                                    </div></div>
                            </div>
        ...
        <!-- 회원가입/정보 부가정보 -->
        <!-- 회원가입/자동등록 방지 --><!-- 회원가입/회원가입/자동등록 방지 -->
